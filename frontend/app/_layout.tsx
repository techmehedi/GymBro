      ...
      <View style={styles.container}>
        ...
        <View style={styles.authContainer}>
          ...
          <View style={styles.authContent}>
            ...
            <Text style={styles.authSubtitle}>Join GymBro and start your fitness journey</Text>
            
            <View style={styles.formContainer}>
              <Text style={styles.inputLabel}>Display Name</Text>
              <View style={styles.inputContainer}>
                <Text style={styles.inputPlaceholder}>Enter your display name</Text>
              </View>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.authContainer}>
          ...
          <View style={styles.authContent}>
            ...
            <Text style={styles.authSubtitle}>Sign in to continue your fitness journey</Text>
